...
export function createAIProviderRegistry(config: {
  ...
  const providers: Record<string, ReturnType<typeof createOpenAI> | ReturnType<typeof createAnthropic> | ReturnType<typeof customProvider>> = {};
...
export function getModelCapabilities(modelId: string): ModelCapabilities {
  ...
  const visionModels = [
    ...
    'llama-3.2-vision', 'gemini-pro-vision',
  ];
...
export function getImageModel(
  ...
  if (provider === "openai" || (provider === "custom" && !customProviderConfig)) {
    const openaiProvider = getOpenAIProvider(apiKey);
...
export const SPEECH_MODELS = [
  ...
  { id: "tts-1-hd", name: "TTS-1 HD (High Quality)", provider: "openai" as const },
  { id: "gpt-4o-mini-tts", name: "GPT-4o Mini TTS", provider: "openai" as const },
] as const;
 ...
 */
export type SpeechOutputFormat = "mp3" | "opus" | "aac" | "flac" | "wav" | "pcm";
...
export const TRANSCRIPTION_MODELS = [
  ...
  { id: "gpt-4o-transcribe", name: "GPT-4o Transcribe", provider: "openai" as const },
  { id: "gpt-4o-mini-transcribe", name: "GPT-4o Mini Transcribe", provider: "openai" as const },
] as const;
