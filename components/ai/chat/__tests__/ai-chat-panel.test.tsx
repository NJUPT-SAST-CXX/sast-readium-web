/**
 * Tests for AIChatPanel component (components/ai/chat/ai-chat-panel.tsx)
 */
...
jest.mock("@/components/ai/tools/research-workflow", () => ({
...
jest.mock("@/components/ai/elements/conversation", () => ({
  ...
  ConversationEmptyState: ({ title, description, children }: any) => (
