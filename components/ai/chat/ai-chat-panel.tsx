...
import { ResearchPanel } from "../tools/research-workflow";
import {
  Conversation,
  ConversationContent,
...
export function AIChatPanel() {
  ...
  return (
    <div className="h-full flex-1 flex flex-col min-h-0 bg-gradient-to-b from-background to-muted/10">
      {/* Hidden file input */}
      <input
        type="file"
        ref={fileInputRef}
      ...
      {mode === "research" ? (
        ...
        <>
          ...
          <div ref={conversationRef} className="flex-1 overflow-hidden min-w-0">
                  ...
                  messages.map((message, messageIndex) => {
                    ...
                    return (
                      <Message
                        ...
                        from={message.role}
                        className={cn(
                          "animate-in fade-in-0 slide-in-from-bottom-2 duration-300 min-w-0",
                          message.role === "user" &&
                        ...
                        <MessageContent
                          className={cn(
                            ...
                            message.role === "assistant" &&
                              "bg-muted/30 rounded-lg p-3 sm:p-4 border border-border/50"
                          )}
                        >
          ...
          <div className="p-2 sm:p-4 border-t border-border/50 bg-gradient-to-t from-background to-muted/10 relative">
