...
import { PDFPropertiesDialog } from "../properties";
import { usePDFStore } from "@/lib/pdf";
import { updatePDFMetadata } from "@/lib/pdf";
...
describe("PDFPropertiesDialog", () => {
  ...
  it("renders properties", () => {
    render(<PDFPropertiesDialog open={true} onOpenChange={jest.fn()} />);
  ...
  it("saves metadata", async () => {
    (updatePDFMetadata as jest.Mock).mockResolvedValue(
      new File([], "updated.pdf")
    );
