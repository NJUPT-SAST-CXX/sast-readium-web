...
import { PDFSettingsDialog } from "../dialogs/settings";
import { PDFMenuBar } from "./menubar";
import { PDFAnnotationsToolbar } from "../annotations/annotations-toolbar";
import { PDFGoToPage } from "../navigation/go-to-page";
import {
  isTauri,
