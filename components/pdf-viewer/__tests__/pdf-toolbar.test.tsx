...
jest.mock("../pdf-annotations-toolbar", () => ({
  PDFAnnotationsToolbar: () => <div data-testid="pdf-annotations-toolbar">PDFAnnotationsToolbar</div>,
}));
jest.mock("../pdf-settings-dialog", () => ({
  PDFSettingsDialog: () => <div data-testid="pdf-settings-dialog">PDFSettingsDialog</div>,
}));
...
describe("PDFToolbar", () => {
  ...
  it("shows search bar when showSearch is true", () => {
    ...
    const searchInput = screen.getByPlaceholderText("toolbar.search.placeholder");
